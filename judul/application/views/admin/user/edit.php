          ...
          <div class="row">
            <div class="col-md-6" style="padding: 10px;">
              ...
              <div class="form-group">
                ...
                <input type="password" name="ulangi_password" id="password" class="form-control" placeholder="Ulangi Password" value="<?= $user->password; ?>" required>
              </div>
            ...
            <div class="col-md-6" style="padding: 10px;">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="akses_level" id="akses_level" required>
                  ...
                  <option <?php if ($user->akses_level == 'Admin') echo 'selected'; ?>>Admin</option>
                  <option <?php if ($user->akses_level == 'Kaprodi') echo 'selected'; ?>>Kaprodi</option>
                </select>
              </div>
